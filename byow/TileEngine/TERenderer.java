...
public class TERenderer {
     ...
     */
    public void renderFrame(World.Game game, boolean light){
        TETile[][] world = game.getGamestate();
        int numXTiles = world.length;
        int numYTiles = world[0].length;
        if(light){
            int avatarX = game.getAvatarX();
            int avatarY = game.getAvatarY();
            int radius = 8;
            int maxX;
            int maxY;
            int minX;
            int minY;
            if(avatarX+radius >= numXTiles){
                maxX = numXTiles;
            }
            else{
                maxX = avatarX + radius;
